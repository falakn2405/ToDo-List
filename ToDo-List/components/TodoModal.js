...
import { View, Text, StyleSheet, SafeAreaView, TouchableOpacity, 
    FlatList, KeyboardAvoidingView, TextInput, Keyboard, Animated, ImageBackground } from 'react-native';
...
export default class TodoModal extends React.Component {
    ...
    render() {
        ...
        const completeCount = list.todos.filter(todos => todos.completed).length

        return(
            <KeyboardAvoidingView style={{flex: 1}} behavior='padding'>
                <ImageBackground source={require('../img/list.jpg')} resizeMode='contain' style={styles.image}>
                    <SafeAreaView style={styles.container}>
                        <TouchableOpacity style={{ position: 'absolute', top: 40, right: 30, zIndex: 10}}
                        ...
                        <View style={[styles.section, styles.header, { borderBottomColor: list.color }]}>
                            <View>
                                ...
                                <Text style={styles.taskCount}>{completeCount} of {taskCount} tasks</Text>
                            </View>
                        </View>
